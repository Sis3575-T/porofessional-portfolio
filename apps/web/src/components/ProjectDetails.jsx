    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/" className="px-6 py-3 btn-ceramic text-gray-900 rounded-lg font-semibold inline-flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen pt-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-12">
        <Link to="/" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 transition mb-8">
          ...
          <div className="h-64 sm:h-80 bg-gray-100 flex items-center justify-center">
            {project.thumbnail ? (
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">{categoryLabels[project.category]}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          {techs.length > 0 && (
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {techs.map((tech) => (
                  <span key={tech} className="px-4 py-2 bg-gray-100 border border-gray-200 text-gray-700 rounded-lg text-sm">
                    {tech}
                  </span>
                ))}
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-3">Challenge</h2>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {features.map((f, i) => (
                  <div key={i} className="flex items-start gap-3 text-gray-600">
                    <span className="w-2 h-2 bg-gray-600 rounded-full mt-2 shrink-0" />
                    <span>{f}</span>
                  </div>
                ))}
              </div>
          ...
          {project.lessonsLearned && (
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-3">Lessons Learned</h2>
              <p className="text-gray-500 leading-relaxed">{project.lessonsLearned}</p>
            </div>
          )}
        </div>
      </div>
